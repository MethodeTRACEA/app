...
import { getActionSuggestions } from "@/lib/action-suggestions";
...
function SessionContent({ userId, isFirstSession }: { userId: string | null; isFirstSession: boolean }) {
  ...
  // ════════════════════════════════════════════════════════
  if (restingScreen) {
    return <RestingScreen seed={traceSeed} onDone={() => setRestingScreen(false)} />;
  }
      ...
      <div className="py-12">
        <div className="flex flex-col items-center justify-center min-h-[80vh] gap-8 animate-fade-up">
          ...
          <button
            ...
            className="font-inter text-base text-[#D99A84] underline decoration-[#D99A84]/50 underline-offset-4 hover:text-[#E8B8A4] transition-colors"
          >
