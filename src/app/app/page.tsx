  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md mx-auto px-6 pb-10 space-y-4 relative z-[1]">
        ...
        {/* Repli in-app (57-5) — filet pour qui n'a pas de push actif.
            Non bloquant, une fois par jour max par rappel dû (voir
            ReminderNudge). Coordonné avec InstallPrompt ci-dessous : pas
            deux demandes différentes en même temps. */}
        <ReminderNudge onVisibilityChange={setNudgeVisible} />

        {stats.total >= 1 && !nudgeVisible && <InstallPrompt />}
